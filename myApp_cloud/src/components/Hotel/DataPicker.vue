    ...
    <div>
                            ...
                            <!-- 日期 -->
                             <div class='calendar-data'>
                               ...
                               :class="item2.disabled + ' '+ item2.disabled2 + ' ' +item2.start_date + ' ' + item2.end_date +' ' + item2.active_date"  
                                v-for="(item2,index) in item.days" :key='index' 
        ...
        <footer>
           <div class="screenbottom">
               ...
               <button class="determine" @click='ok'>确定</button>
                <!-- <div ></div> -->
            </div>
        </footer>        
    <!-- </div> -->
...
export default {
    ...
    methods:{
           ok(){
               console.log('确定')
               console.log('select_start_ymd',this.select_start_ymd)
               console.log('select_end_show',this.select_end_show)
